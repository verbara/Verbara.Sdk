...
Core abstractions for the [Verbara.Sdk](https://github.com/verbara/Verbara.Sdk) ecosystem — shared interfaces, base types, telemetry catalogs, and source-generator attributes consumed by every other package in the family. Native AOT, zero reflection, MIT licensed.
