...
/// <summary>
/// Metrics for webhook delivery. Uses <see cref="Meter"/> name <c>Verbara.Sdk.Push.Webhooks</c>
/// so it enrolls in <c>Verbara.Sdk.Hosting.VerbaraTelemetry.MeterNames</c>.
/// </summary>
internal sealed class WebhookMetrics : IDisposable
{
    public const string MeterName = "Verbara.Sdk.Push.Webhooks";
