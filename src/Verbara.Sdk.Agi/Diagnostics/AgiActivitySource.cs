...
namespace Verbara.Sdk.Agi.Diagnostics;

// Tag names follow VerbaraSemanticConventions (asterisk.channel.name for
...
/// <c>builder.AddSource("Verbara.Sdk.Agi")</c>
/// </para>
/// </summary>
public static class AgiActivitySource
{
    public static readonly ActivitySource Source = new("Verbara.Sdk.Agi", "1.0.0");
