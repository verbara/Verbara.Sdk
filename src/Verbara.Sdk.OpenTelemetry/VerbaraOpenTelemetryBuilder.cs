...
/// <summary>
/// Fluent builder passed to <see cref="VerbaraOpenTelemetryExtensions.AddVerbaraOpenTelemetry"/>.
...
/// </summary>
public sealed class VerbaraOpenTelemetryBuilder
{
    ...
    /// </summary>
    public VerbaraOpenTelemetryBuilder WithConsoleExporter()
    {
    ...
    /// </summary>
    public VerbaraOpenTelemetryBuilder WithOtlpExporter(
    ...
    /// </summary>
    public VerbaraOpenTelemetryBuilder WithPrometheusExporter()
    {
    ...
    /// </summary>
    public VerbaraOpenTelemetryBuilder ConfigureTracing(Action<TracerProviderBuilder> configure)
    {
    ...
    /// </summary>
    public VerbaraOpenTelemetryBuilder ConfigureMetrics(Action<MeterProviderBuilder> configure)
    {
        ArgumentNullException.ThrowIfNull(configure);
