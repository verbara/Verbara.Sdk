...
/// <summary>Constants for Azure Cognitive Services TTS output format values.</summary>
public static class AzureTtsOutputFormat
{
    /// <summary>Raw 8 kHz, 16-bit mono PCM.</summary>
    public const string Raw8Khz16BitMonoPcm = "raw-8khz-16bit-mono-pcm";

    /// <summary>Raw 16 kHz, 16-bit mono PCM.</summary>
    public const string Raw16Khz16BitMonoPcm = "raw-16khz-16bit-mono-pcm";

    /// <summary>Raw 24 kHz, 16-bit mono PCM.</summary>
    public const string Raw24Khz16BitMonoPcm = "raw-24khz-16bit-mono-pcm";

    /// <summary>Raw 48 kHz, 16-bit mono PCM.</summary>
