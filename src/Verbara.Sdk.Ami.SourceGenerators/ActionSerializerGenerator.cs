...
public sealed class ActionSerializerGenerator : IIncrementalGenerator
{
        ...
        GeneratorAttributeSyntaxContext ctx, CancellationToken ct)
    {
        ...
        var attr = ctx.Attributes.FirstOrDefault(a =>
            a.AttributeClass?.ToDisplayString() == VerbaraMappingFqn);
    ...
    private static string GenerateSerializer(ImmutableArray<ActionInfo> actions)
    {
        ...
        sb.AppendLine("using Verbara.Sdk;");
        sb.AppendLine();
        sb.AppendLine("namespace Verbara.Sdk.Ami.Generated;");
        sb.AppendLine();
        ...
        foreach (var action in sorted)
        {
            ...
            {
                sb.AppendLine("        foreach (var kvp in ((global::Verbara.Sdk.IHasExtraFields)a).GetExtraFields())");
