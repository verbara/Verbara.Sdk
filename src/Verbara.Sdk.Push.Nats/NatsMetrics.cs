...
/// <summary>
/// Metrics for the NATS bridge. Uses meter name <c>Verbara.Sdk.Push.Nats</c> so it
/// enrolls in <c>Verbara.Sdk.Hosting.VerbaraTelemetry.MeterNames</c> once registered.
/// </summary>
internal sealed class NatsMetrics : IDisposable
{
    public const string MeterName = "Verbara.Sdk.Push.Nats";
