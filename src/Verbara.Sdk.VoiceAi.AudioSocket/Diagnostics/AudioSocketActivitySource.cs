...
namespace Verbara.Sdk.VoiceAi.AudioSocket.Diagnostics;
...
/// <para>
/// Note: this package does not reference <c>Verbara.Sdk</c> core (only <c>Verbara.Sdk.Audio</c>),
/// so the channel-id tag here uses a local string rather than
/// <c>VerbaraSemanticConventions.Channel.Id</c>. Consumers can map both at the dashboard
...
/// <c>builder.AddSource("Verbara.Sdk.VoiceAi.AudioSocket")</c>
/// </para>
/// </summary>
public static class AudioSocketActivitySource
{
    public static readonly ActivitySource Source = new("Verbara.Sdk.VoiceAi.AudioSocket", "1.0.0");
