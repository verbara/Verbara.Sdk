...
/// <para>
/// Usage: <c>dotnet-counters monitor --process-id &lt;pid&gt; Verbara.Sdk.VoiceAi.AudioSocket</c>
/// </para>
/// </summary>
public static class AudioSocketMetrics
{
    public static readonly Meter Meter = new("Verbara.Sdk.VoiceAi.AudioSocket", "1.0.0");
