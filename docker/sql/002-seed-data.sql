...
INSERT INTO ps_endpoints (id, transport, aors, auth, context, disallow, allow, direct_media, callerid) VALUES
    ('2001', 'transport-udp', '2001', '2001', 'from-internal', 'all', 'ulaw,alaw', 'no', '"Sales Agent 1" <2001>'),
    ('2002', 'transport-udp', '2002', '2002', 'from-internal', 'all', 'ulaw,alaw', 'no', '"Sales Agent 2" <2002>'),
    ('2003', 'transport-udp', '2003', '2003', 'from-internal', 'all', 'ulaw,alaw', 'no', '"Sales Agent 3" <2003>');
...
INSERT INTO ps_endpoints (id, transport, aors, auth, context, disallow, allow, direct_media, callerid) VALUES
    ('3001', 'transport-udp', '3001', '3001', 'from-internal', 'all', 'ulaw,alaw', 'no', '"Support Agent 1" <3001>'),
    ('3002', 'transport-udp', '3002', '3002', 'from-internal', 'all', 'ulaw,alaw', 'no', '"Support Agent 2" <3002>'),
    ('3003', 'transport-udp', '3003', '3003', 'from-internal', 'all', 'ulaw,alaw', 'no', '"Support Agent 3" <3003>');
