...
### Fixed — Both session-store figures were re-measured, and the Postgres one was measuring the disk
...
- **Redis was understated ~2.6× on single saves and ~1.4× on batch**: now **~33.3K saves/sec
  (p50 30 µs) / batch 91,021 sess/sec**, where the table said ~12.6K (p50 79 µs) / 65,738.
