...
public sealed class VerbaraServerTests : IAsyncDisposable
{
    ...
    public async Task StartAsync_ShouldPopulateChannelsFromStatusAction()
    {
        ...
        var statusEvent = new Verbara.Sdk.Ami.Events.StatusEvent
        {
            UniqueId = "123.1",
    ...
    {
        var originateResponse = new Verbara.Sdk.Ami.Events.OriginateResponseEvent
        {
            Response = "Success",
            Channel = "PJSIP/2000-001"
        };
    ...
    {
        var queueParams = new Verbara.Sdk.Ami.Events.QueueParamsEvent
        {
            Queue = "sales",
            Max = 10,
            Strategy = "ringall"
    ...
    {
        var agentEvent = new Verbara.Sdk.Ami.Events.AgentsEvent
        {
            Agent = "2001",
            Status = "AGENT_IDLE"
        };
