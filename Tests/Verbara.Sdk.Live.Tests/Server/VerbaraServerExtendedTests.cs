...
public sealed class VerbaraServerExtendedTests : IAsyncDisposable
{
    ...
    public VerbaraServerExtendedTests()
    {
    ...
    public async Task EventObserver_ShouldRouteNewStateEvent()
    {
        ...
        _sut.Channels.GetByUniqueId("uid-1")!.State
            .Should().Be(Verbara.Sdk.Enums.ChannelState.Up);
    }
    ...
    public async Task EventObserver_ShouldRouteAgentLogoffEvent()
    {
        ...
        _sut.Agents.GetById("1001")!.State
            .Should().Be(Verbara.Sdk.Live.Agents.AgentState.LoggedOff);
    }
    ...
    public async Task EventObserver_ShouldRouteAgentConnectEvent()
    {
        ...
        _sut.Agents.GetById("1001")!.State
            .Should().Be(Verbara.Sdk.Live.Agents.AgentState.OnCall);
    }
    ...
    public async Task EventObserver_ShouldRouteAgentCompleteEvent()
    {
        ...
        agent.State.Should().Be(Verbara.Sdk.Live.Agents.AgentState.Available);
