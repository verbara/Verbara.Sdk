...
public class WebSocketAudioSessionTests
{
    ...
    public async Task DtmfControlMessage_ShouldEmitDtmfReceivedEvent_WhenActivityCurrent()
    {
        ...
        events.Should().ContainSingle(e => e.Name == VerbaraSemanticConventions.Events.DtmfReceived);
        var dtmfEvent = events.Single(e => e.Name == VerbaraSemanticConventions.Events.DtmfReceived);
        dtmfEvent.Tags.Should().Contain(t => t.Key == VerbaraSemanticConventions.Channel.Id && (string)t.Value! == "PJSIP/alice-00042");
    ...
    public async Task HangupControlMessage_ShouldEmitChannelHangupEvent_WhenActivityCurrent()
    {
        ...
        var events = activity!.Events.ToList();
        events.Should().ContainSingle(e => e.Name == VerbaraSemanticConventions.Events.ChannelHangup);
        var hangupEvent = events.Single(e => e.Name == VerbaraSemanticConventions.Events.ChannelHangup);
        hangupEvent.Tags.Should().Contain(t => t.Key == VerbaraSemanticConventions.Channel.Id && (string)t.Value! == "PJSIP/bob-00099");
    ...
    public async Task MediaStartControlMessage_ShouldEmitMediaStartedEvent_WhenActivityCurrent()
    {
        ...
        var evt = activity!.Events.Single(e => e.Name == VerbaraSemanticConventions.Events.MediaStarted);
        evt.Tags.Should().Contain(t => t.Key == VerbaraSemanticConventions.Channel.Id && (string)t.Value! == "PJSIP/start-001");
        evt.Tags.Should().Contain(t => t.Key == VerbaraSemanticConventions.Media.Codec && (string)t.Value! == "slin16");
        evt.Tags.Should().Contain(t => t.Key == VerbaraSemanticConventions.Media.SampleRate && (int)t.Value! == 16000);
    ...
    public async Task MediaBufferingControlMessage_ShouldEmitMediaBufferingEvent_WhenActivityCurrent()
    {
        ...
        var evt = activity!.Events.Single(e => e.Name == VerbaraSemanticConventions.Events.MediaBuffering);
        evt.Tags.Should().Contain(t => t.Key == VerbaraSemanticConventions.Channel.Id && (string)t.Value! == "PJSIP/buf-007");
    ...
    public async Task MediaMarkProcessedControlMessage_ShouldEmitMarkProcessedEvent_WhenActivityCurrent()
    {
        ...
        var evt = activity!.Events.Single(e => e.Name == VerbaraSemanticConventions.Events.MediaMarkProcessed);
        evt.Tags.Should().Contain(t => t.Key == VerbaraSemanticConventions.Channel.Id && (string)t.Value! == "PJSIP/mark-77");
