...
{
    [Fact]
    public void AddVerbaraPush_ShouldRegisterAllRequiredServices()
    {
    ...
    [Fact]
    public void AddVerbaraPush_ShouldRegisterTopicRegistry_AsSingleton()
    {
        var services = new ServiceCollection();
        services.AddLogging();
        services.AddVerbaraPush();
    ...
    [Fact]
    public void AddVerbaraPush_ShouldRegisterAllowAllAuthorizer_ByDefault()
    {
        var services = new ServiceCollection();
        services.AddLogging();
        services.AddVerbaraPush();
    ...
    [Fact]
    public void AddVerbaraPush_ShouldNotOverrideAuthorizer_WhenAlreadyRegistered()
    {
        var services = new ServiceCollection();
        services.AddLogging();
        // Register a custom authorizer before calling AddVerbaraPush
    ...
    [Fact]
    public void AddVerbaraPush_ShouldApplyConfigureAction_WhenProvided()
    {
        var services = new ServiceCollection();
        services.AddLogging();
    ...
    [Fact]
    public void AddVerbaraPush_ShouldValidateOptions_WhenInvalidBufferCapacity()
    {
        var services = new ServiceCollection();
        services.AddLogging();
        services.AddVerbaraPush(o => o.BufferCapacity = 0);
        using var sp = services.BuildServiceProvider();
