...
{
    [Fact]
    public void AddVerbaraPushAspNetCore_ShouldRegisterAllRequiredServices()
    {
    ...
    [Fact]
    public void AddVerbaraPushAspNetCore_ShouldRegisterDefaultAuthorizer_WhenNoneRegistered()
    {
        var services = new ServiceCollection();
        services.AddLogging();
        services.AddVerbaraPushAspNetCore();
    ...
    [Fact]
    public void AddVerbaraPushAspNetCore_ShouldPassConfigureDelegate_ToPushOptions()
    {
        var services = new ServiceCollection();
        services.AddLogging();
        services.AddVerbaraPushAspNetCore(o => o.BufferCapacity = 64);
        using var sp = services.BuildServiceProvider();
    ...
    [Fact]
    public void AddVerbaraPushAspNetCore_ShouldResolveEventBus_WhenCalledTwice()
    {
        var services = new ServiceCollection();
        services.AddLogging();
        services.AddVerbaraPushAspNetCore();
    ...
    [Fact]
    public void AddVerbaraPushAspNetCore_ThrowsArgumentNullException_WhenServicesIsNull()
    {
        IServiceCollection? services = null;
        var act = () => services!.AddVerbaraPushAspNetCore();
