namespace Verbara.Sdk.FunctionalTests.Layer2_UnitProtocol.SourceGenerators;
...
public sealed class BulkRoundtripTests
{
    ...
    public static TheoryData<string, Type> AllEventMappings
    {
        get
        {
            ...
            var amiAssembly = typeof(Verbara.Sdk.Ami.Events.NewChannelEvent).Assembly;
            ...
            {
                var attr = type.GetCustomAttribute<VerbaraMappingAttribute>();
                if (attr is null)
                    continue;
    ...
    public static TheoryData<string, Type> AllActionMappings
    {
        get
        {
            ...
            var amiAssembly = typeof(Verbara.Sdk.Ami.Actions.PingAction).Assembly;
    ...
    public static TheoryData<string, Type> AllResponseMappings
    {
        get
        {
            ...
            var amiAssembly = typeof(Verbara.Sdk.Ami.Responses.PingResponse).Assembly;
