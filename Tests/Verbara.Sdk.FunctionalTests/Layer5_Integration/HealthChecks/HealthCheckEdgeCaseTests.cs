namespace Verbara.Sdk.FunctionalTests.Layer5_Integration.HealthChecks;
...
public sealed class HealthCheckEdgeCaseTests : FunctionalTestBase
{
    ...
    public async Task AllHealthChecks_ShouldBeRegistrable_ViaHostBuilder()
    {
        ...
        using (host)
        {
            ...
            healthCheckService.Should().NotBeNull("HealthCheckService must be registered via AddVerbara");
