namespace Verbara.Sdk.FunctionalTests.Layer5_Integration.Diagnostics;
...
/// <see cref="Verbara.Sdk.Ami.Diagnostics.AmiMetrics.Meter"/>).
/// </para>
///
/// <para>
...
public sealed class AmiGaugeReconnectTests : FunctionalTestBase
{
    ...
    private static Dictionary<string, List<double>> SnapshotObservableGauges(TimeSpan settleDelay)
    {
        ...
        {
            if (instrument.Meter.Name == "Verbara.Sdk.Ami"
