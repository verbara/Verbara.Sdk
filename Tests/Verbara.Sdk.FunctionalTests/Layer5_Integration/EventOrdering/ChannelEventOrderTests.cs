namespace Verbara.Sdk.FunctionalTests.Layer5_Integration.EventOrdering;
...
public sealed class ChannelEventOrderTests : FunctionalTestBase
{
    ...
    public async Task ChannelRename_ShouldUpdateSecondaryIndex()
    {
        ...
        // Track renames via ChannelStateChanged (rename also triggers state update in VerbaraServer)
