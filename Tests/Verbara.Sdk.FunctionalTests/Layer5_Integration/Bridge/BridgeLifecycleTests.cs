namespace Verbara.Sdk.FunctionalTests.Layer5_Integration.Bridge;
...
{
    public BridgeLifecycleTests() : base("Verbara.Sdk.Ami")
    {
    }
    ...
    /// <summary>
    /// BridgeManager on VerbaraServer should track active bridges when channels enter a ConfBridge.
    /// </summary>
    [Fact]
