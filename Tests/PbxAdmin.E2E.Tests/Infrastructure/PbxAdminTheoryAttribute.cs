...
/// <summary>
/// Skips the theory if PbxAdmin is not reachable at localhost:8080,
/// or if Playwright browsers are not installed.
/// </summary>
public sealed class PbxAdminTheoryAttribute : TheoryAttribute
{
    private static readonly string? s_skipReason = DetectSkipReason();

    public PbxAdminTheoryAttribute()
    {
