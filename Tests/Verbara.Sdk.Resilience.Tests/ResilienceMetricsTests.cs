...
namespace Verbara.Sdk.Resilience.Tests;
...
public sealed class ResilienceMetricsTests
{
    ...
    {
        ResilienceMetrics.MeterName.Should().Be("Verbara.Sdk.Resilience");
        ResilienceMetrics.Meter.Name.Should().Be("Verbara.Sdk.Resilience");
    }
