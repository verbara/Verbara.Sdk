...
public class SprintAEventTests
{
    ...
    public void Event_ShouldHaveCorrectVerbaraMapping(Type eventType, string expectedMapping)
    {
        var attr = eventType.GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
