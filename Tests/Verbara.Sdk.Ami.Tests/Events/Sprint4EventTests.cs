...
namespace Verbara.Sdk.Ami.Tests.Events;
...
public class Sprint4EventTests
{
    ...
    {
        var attr = typeof(IdentifyDetailEvent).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
        attr.Should().ContainSingle().Which.Should().BeOfType<VerbaraMappingAttribute>()
    ...
    {
        var attr = typeof(InboundRegistrationDetailEvent).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
        attr.Should().ContainSingle().Which.Should().BeOfType<VerbaraMappingAttribute>()
    ...
    {
        var attr = typeof(OutboundRegistrationDetailEvent).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
        attr.Should().ContainSingle().Which.Should().BeOfType<VerbaraMappingAttribute>()
    ...
    {
        var attr = typeof(InboundSubscriptionDetailEvent).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
        attr.Should().ContainSingle().Which.Should().BeOfType<VerbaraMappingAttribute>()
    ...
    {
        var attr = typeof(OutboundSubscriptionDetailEvent).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
        attr.Should().ContainSingle().Which.Should().BeOfType<VerbaraMappingAttribute>()
    ...
    {
        var attr = typeof(AorListEvent).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
        attr.Should().ContainSingle().Which.Should().BeOfType<VerbaraMappingAttribute>()
    ...
    {
        var attr = typeof(AuthListEvent).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
        attr.Should().ContainSingle().Which.Should().BeOfType<VerbaraMappingAttribute>()
    ...
    {
        var attr = typeof(ResourceListDetailEvent).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
        attr.Should().ContainSingle().Which.Should().BeOfType<VerbaraMappingAttribute>()
    ...
    {
        var attr = typeof(FAXSessionEvent).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
        attr.Should().ContainSingle().Which.Should().BeOfType<VerbaraMappingAttribute>()
    ...
    {
        var attr = typeof(FAXSessionsEntryEvent).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
        attr.Should().ContainSingle().Which.Should().BeOfType<VerbaraMappingAttribute>()
    ...
    {
        var attr = typeof(FAXSessionsCompleteEvent).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
        attr.Should().ContainSingle().Which.Should().BeOfType<VerbaraMappingAttribute>()
    ...
    {
        var attr = typeof(DeadlockStartEvent).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
        attr.Should().ContainSingle().Which.Should().BeOfType<VerbaraMappingAttribute>()
    ...
    {
        var attr = typeof(AocDEvent).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
        attr.Should().ContainSingle().Which.Should().BeOfType<VerbaraMappingAttribute>()
    ...
    {
        var attr = typeof(AocEEvent).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
        attr.Should().ContainSingle().Which.Should().BeOfType<VerbaraMappingAttribute>()
    ...
    {
        var attr = typeof(AocSEvent).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
        attr.Should().ContainSingle().Which.Should().BeOfType<VerbaraMappingAttribute>()
