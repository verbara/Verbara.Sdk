...
public class EventInheritanceTests
{
    ...
    [Fact]
    public void HangupEvent_ShouldHaveVerbaraMapping()
    {
        var attr = typeof(HangupEvent).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
    ...
    [Fact]
    public void NewChannelEvent_ShouldHaveVerbaraMapping()
    {
        var attr = typeof(NewChannelEvent).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
        attr.Should().ContainSingle()
            .Which.Should().BeOfType<VerbaraMappingAttribute>()
