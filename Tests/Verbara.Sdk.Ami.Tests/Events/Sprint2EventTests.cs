...
public class Sprint2EventTests
{
    ...
    {
        var attr = typeof(PresenceStateChangeEvent).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
    ...
    {
        var attr = typeof(PresenceStatusEvent).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
        attr.Should().ContainSingle().Which.Should().BeOfType<VerbaraMappingAttribute>()
    ...
    {
        var attr = typeof(UserEventEvent).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
        attr.Should().ContainSingle().Which.Should().BeOfType<VerbaraMappingAttribute>()
    ...
    public void ConfbridgeMuteEvent_ShouldInheritFromConfbridgeEventBase()
    {
        ...
        var attr = typeof(ConfbridgeMuteEvent).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
        attr.Should().ContainSingle().Which.Should().BeOfType<VerbaraMappingAttribute>()
    ...
    public void ConfbridgeUnmuteEvent_ShouldInheritFromConfbridgeEventBase()
    {
        ...
        var attr = typeof(ConfbridgeUnmuteEvent).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
        attr.Should().ContainSingle().Which.Should().BeOfType<VerbaraMappingAttribute>()
