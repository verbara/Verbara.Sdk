...
public class SprintCActionTests
{
    ...
    [Fact]
    public void VoicemailRefreshAction_ShouldHaveVerbaraMapping()
    {
        var attr = typeof(VoicemailRefreshAction)
            .GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
    ...
    [Fact]
    public void VoicemailUserStatusAction_ShouldHaveVerbaraMapping()
    {
    ...
    [Fact]
    public void PresenceStateAction_ShouldHaveVerbaraMapping()
    {
    ...
    [Fact]
    public void PresenceStateListAction_ShouldHaveVerbaraMapping()
    {
    ...
    [Fact]
    public void QueueReloadAction_ShouldHaveVerbaraMapping()
    {
    ...
    [Fact]
    public void QueueRuleAction_ShouldHaveVerbaraMapping()
    {
    ...
    [Fact]
    public void DbGetTreeAction_ShouldHaveVerbaraMapping()
    {
    ...
    [Fact]
    public void CoreShowChannelMapAction_ShouldHaveVerbaraMapping()
    {
    ...
    [Fact]
    public void SendFlashAction_ShouldHaveVerbaraMapping()
    {
    ...
    [Fact]
    public void DialplanExtensionAddAction_ShouldHaveVerbaraMapping()
    {
    ...
    [Fact]
    public void DialplanExtensionRemoveAction_ShouldHaveVerbaraMapping()
    {
    ...
    [Fact]
    public void QueueRuleEvent_ShouldHaveVerbaraMapping()
    {
    ...
    [Fact]
    public void QueueRuleListCompleteEvent_ShouldHaveVerbaraMapping()
    {
    ...
    [Fact]
    public void DbGetTreeResponseEvent_ShouldHaveVerbaraMapping()
    {
    ...
    [Fact]
    public void CoreShowChannelMapCompleteEvent_ShouldHaveVerbaraMapping()
    {
