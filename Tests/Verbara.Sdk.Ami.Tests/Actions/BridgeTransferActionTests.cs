...
public class BridgeTransferActionTests
{
    ...
    {
        var attr = typeof(BridgeDestroyAction).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
    ...
    {
        var attr = typeof(BridgeInfoAction).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
        attr.Should().ContainSingle()
            .Which.Should().BeOfType<VerbaraMappingAttribute>()
    ...
    {
        var attr = typeof(BridgeKickAction).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
        attr.Should().ContainSingle()
            .Which.Should().BeOfType<VerbaraMappingAttribute>()
    ...
    {
        var attr = typeof(BridgeListAction).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
        attr.Should().ContainSingle()
            .Which.Should().BeOfType<VerbaraMappingAttribute>()
    ...
    {
        var attr = typeof(BridgeTechnologyListAction).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
        attr.Should().ContainSingle()
            .Which.Should().BeOfType<VerbaraMappingAttribute>()
    ...
    {
        var attr = typeof(BridgeTechnologySuspendAction).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
        attr.Should().ContainSingle()
            .Which.Should().BeOfType<VerbaraMappingAttribute>()
    ...
    {
        var attr = typeof(BridgeTechnologyUnsuspendAction).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
        attr.Should().ContainSingle()
            .Which.Should().BeOfType<VerbaraMappingAttribute>()
    ...
    {
        var attr = typeof(BlindTransferAction).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
        attr.Should().ContainSingle()
            .Which.Should().BeOfType<VerbaraMappingAttribute>()
    ...
    {
        var attr = typeof(CancelAtxferAction).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
        attr.Should().ContainSingle()
            .Which.Should().BeOfType<VerbaraMappingAttribute>()
