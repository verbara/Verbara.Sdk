...
namespace Verbara.Sdk.Ami.Tests.Responses;

public class ResponsePropertyTests
{
    [Fact]
    public void PingResponse_ShouldHaveVerbaraMapping()
    {
        var attr = typeof(PingResponse).GetCustomAttributes(typeof(VerbaraMappingAttribute), false);
